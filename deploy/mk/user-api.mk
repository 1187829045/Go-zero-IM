...
# 测试下的编译文件
DOCKER_FILE_TEST=$(realpath ./deploy/dockerfile/Dockerfile_${SERVER_NAME}_${SERVER_TYPE}_dev)

# 测试环境的编译发布
build-test:
	GOOS=linux GOARCH=amd64 CGO_ENABLED=0 /usr/local/go/bin/go build -o bin/${SERVER_NAME}-${SERVER_TYPE} ./apps/${SERVER_NAME}/${SERVER_TYPE}/${SERVER_NAME}.go
